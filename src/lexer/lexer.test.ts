...
import { TokenItem, TokenType } from "../token/token";
...
`;
  ...
  const tests: {
    expectedType: TokenItem,
    expectedLiteral: string,
  }[] = [
      {
        expectedType: TokenType.LET,
        expectedLiteral: 'let'
      },
      {
      ...
      {
        expectedType: TokenType.FUNCTION,
        expectedLiteral: 'fn'
      },
      {
      ...
      {
        expectedType: TokenType.BANG,
        expectedLiteral: '!'
      },
      {
        expectedType: TokenType.MINUS,
        expectedLiteral: '-'
      },
      {
        expectedType: TokenType.SLASH,
        expectedLiteral: '/'
      },
      {
        expectedType: TokenType.ASTERISK,
        expectedLiteral: '*'
      },
      {
        expectedType: TokenType.INT,
      ...
      {
        expectedType: TokenType.RETURN,
        expectedLiteral: 'return'
      },
      {
        expectedType: TokenType.TRUE,
  ...
  for (const test of tests) {
    expect(lexer.nextToken().type).toBe(test.expectedType);
  }
});
